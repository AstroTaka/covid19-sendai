<template>
  <div class="About">
    ...
    <StaticCard>
      <h3>免責事項</h3>
      <p>
        当サイトに掲載されている情報の正確性については万全を期していますが、千葉県は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。
      </p>
      <p>
    ...
    <!-- <StaticCard>
      ...
      <p>本サイトで公表しているデータは、<a
        ...
        rel="noopener"
        >東京都オープンデータカタログサイト</a
      >より誰でも自由にダウンロードが可能です。（データは順次追加予定です）</p>
    </StaticCard> -->
    <StaticCard>
      <h3>ソースコードについて</h3>
      <p>
    ...
    <!-- <StaticCard>
      <h3>お問い合わせ先（都のHPサイトポリシーについて）</h3>
      <p>東京都生活文化局広報広聴部広報課<br />
      電話
      <a href="tel:03-5388-3085">03-5388-3085</a></p>
    </StaticCard> -->
  </div>
</template>
